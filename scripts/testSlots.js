...
console.log('[PASS] Time conversion tests passed');
...
console.log('[PASS] 30-min slot generation passed:', slots30);
...
console.log('[PASS] 15-min slot generation passed:', slots15);
...
console.log('[PASS] Day of week calculation passed (2026-09-10 is Thursday)');
